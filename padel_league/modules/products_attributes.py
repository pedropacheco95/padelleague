...
def create():
    if request.method == "POST":
        ...
        for value in values:
            if value:
                product_value = ProductAttributeValue(
                    value=value, product_attribute_id=product_attribute.id
                )
...
def edit(id=None):
    if not id:
        ...
        return render_template(
            "product_attributes/edit_choose.html", product_attributes=product_attributes
        )
    ...
    return render_template(
        "product_attributes/edit.html", product_attribute=product_attribute
    )
