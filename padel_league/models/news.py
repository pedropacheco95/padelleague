...
class News(db.Model, model.Model):
    ...
    #
    #        first_division = (
    #            Division.query.filter_by(rating=2000).order_by(Division.id.desc()).first()
    #        )
    #        second_division = (
    #            Division.query.filter_by(rating=500).order_by(Division.id.desc()).first()
    #        )
    #
    ...
    #
    #        next_matches_first_division = first_division.get_next_matchweek_games(
    #            matchweek + 1
    #        )
    #        next_matches_second_division = second_division.get_next_matchweek_games(
    #            matchweek + 1
    #        )
    #        next_matches = (
    #            f"Próximos jogos (Jornada {matchweek + 1}):\n Primeira divisão: {next_matches_first_division}\n Primeira divisão: {next_matches_second_division}"
    #            if next_matches_first_division and next_matches_second_division
    #            else "O torneio acabou nesta jornada."
    #        )
    #
    ...
    #        predictions_guy = News.news_creation_predict_next_week_scores(
    #            Division, matchweek
    #        )
    #        charecteristics_guy = """
