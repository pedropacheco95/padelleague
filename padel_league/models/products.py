...
class Product(db.Model, model.Model):
    ...
    product_attributes_relations = relationship(
        "Association_ProductProductAttribute", back_populates="product"
    )
    product_attribute_values_relations = relationship(
        "Association_ProductProductAttributeValue", back_populates="product"
    )
