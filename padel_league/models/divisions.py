...
class Division(db.Model ,model.Model , model.Base):
    ...
    logo_image_path = Column(String(80), default='division_logo_image_default.png')
    large_picture_path = Column(String(80), default='division_large_picture_default.png')
