...
def upgrade():
    ...
    op.add_column('images', sa.Column('content_type', sa.String(length=128), nullable=True))
    ...
    op.alter_column('images', 'object_key', existing_type=sa.String(length=512), nullable=False)
...
def downgrade():
    ...
    op.alter_column('images', 'object_key', existing_type=sa.String(length=512), nullable=True)
