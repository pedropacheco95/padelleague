...
def upgrade():
    ...
    op.execute("ALTER TABLE players  ADD COLUMN IF NOT EXISTS picture_id       INTEGER;")
    op.execute("ALTER TABLE players  ADD COLUMN IF NOT EXISTS large_picture_id INTEGER;")
    op.execute("ALTER TABLE news     ADD COLUMN IF NOT EXISTS cover_image_id   INTEGER;")
    op.execute("ALTER TABLE sponsors ADD COLUMN IF NOT EXISTS image_id         INTEGER;")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS ix_players_picture_id        ON players  (picture_id);")
    op.execute("CREATE INDEX IF NOT EXISTS ix_players_large_picture_id  ON players  (large_picture_id);")
    op.execute("CREATE INDEX IF NOT EXISTS ix_news_cover_image_id       ON news     (cover_image_id);")
    op.execute("CREATE INDEX IF NOT EXISTS ix_sponsors_image_id         ON sponsors (image_id);")
