...
def upgrade():
    ...
    op.add_column("divisions", sa.Column("large_picture_id", sa.Integer(), nullable=True))
    op.create_foreign_key(
        "fk_divisions_logo_image", "divisions", "images",
        ["logo_image_id"], ["id"], ondelete="SET NULL"
    )
    op.create_foreign_key(
        "fk_divisions_large_picture", "divisions", "images",
        ["large_picture_id"], ["id"], ondelete="SET NULL"
    )
